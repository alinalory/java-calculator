...
public class Mesaje {
    public static String user = "Introdu userul:";
    public static String parola = "Introdu parola:";
    public static String eroare_input = "Eroare! Mai incearca odata!";
    public static String eroare_login = "Userul sau parola sunt invalide!";
    public static String logout = "Ai fost delogat cu succes!";
